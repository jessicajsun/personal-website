        ...
        <section className={styles.topPanel}>
          ...
          <div className={styles.summary}>
            ...
            <div className={styles.description}>
              ...
              <p></p>
              Therefore, when I became Logistics Director for my first Blueprint, <span style={{fontWeight: '600'}}>one of my main goals was making the hackathon more beginner-friendly.</span> I knew firsthand how overwhelming coding might initially seem, and I wanted to create a welcoming and supportive environment for our attendees. I visited local high schools and encouraged students historically underrepresented in tech to apply. I worked with our DevOps and Marketing teams to develop <a style={{textDecoration: 'underline', color: '#34BAC8'}} href="https://starthacking.org/">StartHacking</a>, which combined an in-person curriculum with online resources to help students start building software projects.
            </div>
